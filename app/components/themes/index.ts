...
export const THEMES: Record<string, ThemeDefinition> = {
  ...
  minimal: {
    ...
    input: "bg-gray-50 border border-gray-200 rounded-xl p-5 outline-none focus:border-[#64748B]",
    button: "bg-[#64748B] text-white rounded-xl font-bold py-4 active:opacity-80 transition-all",
